  ...
  return (
    <div className="relative font-style flex  w-full items-center justify-center" >
      <div className='bg-[#DDEFF9] mb-2 rounded-lg'>
        ...
        <div className=" font-style md:w-[530px] w-[350px] flex flex-col mx-auto my-2 rounded-lg text-slate-950 bg-[#DDEFF9] md:max-w-xl md:flex-row items-center hover:brightness-90 transition duration-200 ease-in-out " onClick={handleClick}>
          <img
